...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div class="content">
		<div class="title m-b-md">
		    <a href="http://logsite.com/posts">Logan's Posts</a>
		</div>
<!-- GitHub links to posts -->
		<div class="links">
		    <a href="http://logsite.com/posts/#">Post 1</a>
		</div>
    ...
    <body>
        <div class="flex-center position-ref part-height">
            ...
            @endif
            <div class="content">
		Here you can find my thoughts on various topics, ranging from economics to video games.
<!--
