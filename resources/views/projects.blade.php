...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div class="content">
		<div class="title m-b-md">
		    <a href="http://logsite.com/projects">Logan's Projects</a>
		</div>
<!-- GitHub links to projects -->
		<div class="links">
		    <a href="http://logsite.com/projects/wot_dis">Wot Dis Bot</a>
		    <a href="http://logsite.com/projects/logsite">Logsite.com</a>
		</div>
	</div>
    ...
    <body>
        <div class="flex-center position-ref part-height">
            ...
            <div class="content">
		Here you can find my past, present, and future projects!
<!--
